...
Catatan:
- Path input tetap menggunakan /home/indra/eq_team
- Output model terbaik disimpan sebagai best_cnn_5s.pt
- Arsitektur MobileNetV3 diganti menjadi CNN
"""
...
print("=" * 60)
print("CNN FINAL - 5s Waveform Classification")
print("=" * 60)
print("Device :", DEVICE)
print("AMP    :", AMP)
